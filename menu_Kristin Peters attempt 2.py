        ...
        if int(menu_category) in menu_items.keys():
            ...
            if item_number.isdigit():
                ...
                if item_number in menu_items.keys():
                    ...
                    #extracts and stores the menu item name from the menu items list
                    ...
                    order_list.append({
                        "Item name": item_name,   # The name of the item
                        "Price": menu_items[item_number]["Price"],      # The price of the item
...
for x in range(len(order_list)):
    ...
    print(f"order_list[{x}]: {order_list[x]}")
